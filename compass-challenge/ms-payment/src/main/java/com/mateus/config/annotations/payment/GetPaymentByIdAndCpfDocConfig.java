...
@Operation(summary = "Details a specific payment", description = "This method returns a specific payment. Use the payment id and cpf.", tags = {"Payment"})
...
public @interface GetPaymentByIdAndCpfDocConfig {
}
