...
@Operation(summary = "Details a specific order", description = "This method returns a specific order. Use the order id.", tags = {"Order"})
...
public @interface GetOrderByIdDocConfig {
}
